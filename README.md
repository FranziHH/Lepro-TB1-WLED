...
Um zum Original zurückkehren zu können, habe ich mit dem ESP-Tool die [originale Firmware](/firmware/ESP32-S3-Mini-1_Lepro-TB1.bin) gesichert.
...
Die Images können hier heruntergeladen werden: [Firmware](/firmware/)
